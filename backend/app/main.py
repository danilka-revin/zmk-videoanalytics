...
app=FastAPI(title="ZMK Vision API",version="2.2.4",description="On-premise API контура видеоаналитики",lifespan=lifespan)
...
@app.get("/api/health")
def health(): return {"status":"ok","version":"2.2.4","uptime_seconds":int(time.time()-STARTED),"time":now_iso()}
