...
def test_compose_and_environment_are_consistent():
    ...
    assert compose['services']['api']['environment']['ZMK_INITIAL_PASSWORD'] == '${ZMK_INITIAL_PASSWORD:-admin}'
    assert compose['services']['api']['environment']['ZMK_DIRECTOR_PASSWORD'] == '${ZMK_DIRECTOR_PASSWORD:-director}'
