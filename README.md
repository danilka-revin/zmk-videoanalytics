...
Откройте **События**, включите фильтры по камере/типу/статусу, нажмите **«Выбрать события»**, отметьте нужные строки и подтвердите их одной операцией с комментарием. CSV-экспорт повторяет эти серверные фильтры, а кнопка **«Кадр»** открывает сохранённую разметку конкретного инцидента.
