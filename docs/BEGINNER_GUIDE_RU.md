...
- **Модели** — состояние загрузки модели в worker, безопасный тест, production-активация и мульти-модельный контур с отдельными слотами для людей, касок, спецодежды, телефона, курения и зон;
