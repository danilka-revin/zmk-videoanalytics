...
В Docker-версии вход в браузерную панель включён по умолчанию. Первый пароль: **`1243`**. После входа задайте свой пароль в **Персонализация → Доступ**. Пока вход не выполнен, панель видна только размытым фоном.
